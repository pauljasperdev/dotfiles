#!/usr/bin/env bash
# =============================================================================
# Theme: Catppuccin - Mocha Custom Variant
# Description: Based on catppuccin mocha with green active window
...
declare -gA THEME_COLORS=(
    ...
    # =========================================================================
    # WINDOW (active) — changed to green
    # =========================================================================
    [window-active-base]="#a6e3a1"       # green (was pink #f5c2e7)
